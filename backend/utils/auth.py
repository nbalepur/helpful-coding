...
if not SECRET_KEY or not isinstance(SECRET_KEY, (str, bytes)):
    raise ValueError(
        "SECRET_KEY must be set in the environment (e.g. in root .env) as a non-empty string. "
...
FROM_EMAIL = os.getenv("FROM_CONTACT_EMAIL")
FROM_NAME = os.getenv("FROM_CONTACT_NAME")
...
def send_password_reset_email(email: str, username: str, reset_token: str) -> bool:
    ...
    try:
        ...
        You requested a password reset for your VibeJam account.
